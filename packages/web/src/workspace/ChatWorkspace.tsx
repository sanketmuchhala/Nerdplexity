  ...
  return <div className="np-chat">
    ...
    <div className={`np-chat-scroll ${empty ? 'empty' : ''}`} ref={scroll} onScroll={() => { const el = scroll.current; if (el) { sticky.current = el.scrollHeight - el.scrollTop - el.clientHeight < 90; setShowScroll(!sticky.current); } }}>
      {empty ? <div className="np-welcome">
        <div className="np-orbit" aria-hidden="true"><div className="np-orbit-ring one"/><div className="np-orbit-ring two"/><div className="np-orbit-ring three"/><span className="np-orbit-point a"/><span className="np-orbit-point b"/><span className="np-orbit-point c"/><div className="np-orbit-center"><img src="/brand/nerdplexity-mark.svg" alt=""/></div><span className="np-orbit-caption">LOCAL INTELLIGENCE</span></div>
