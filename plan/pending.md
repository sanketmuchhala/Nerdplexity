...
- **Deep Research** (2026-09-15, R0 and R1 of `plan/deep-research.md`): one search round, quotes checked against pages, cited report, citation check by matching. Open: reflection rounds and a model check of meaning (R2), pacing per provider, depth and plan editing in the app (R3), evaluation (R4), free-router (R5).
