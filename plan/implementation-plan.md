...
- P11.3 verification: typecheck, build, lint pass. Vitest backend 218 (19 agent tests, specialists over HTTP), frontend 49. Playwright 43/43, including ensemble with draft inspection and writer credit, plan with parts, direct for greetings, and the Specialists table. No live provider was used.
