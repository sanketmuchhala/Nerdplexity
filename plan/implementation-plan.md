...
- Pending items across all phases are now tracked in [pending.md](pending.md). Owner decisions (2026-09-11): documents stay local; web search uses Exa (P6.2); MCP is deferred.
- Next: P7, run analytics and release hardening.
